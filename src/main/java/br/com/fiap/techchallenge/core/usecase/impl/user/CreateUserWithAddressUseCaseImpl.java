...
import br.com.fiap.techchallenge.core.usecase.in.user.CreateUserWithAddressUseCase;
import br.com.fiap.techchallenge.core.usecase.out.AddressRepositoryPort;
import br.com.fiap.techchallenge.core.usecase.out.UserAddressRepositoryPort;
import br.com.fiap.techchallenge.core.usecase.out.UserRepositoryPort;

public class CreateUserWithAddressUseCaseImpl implements CreateUserWithAddressUseCase {

    private final UserRepositoryPort userRepository;
    private final UserAddressRepositoryPort userAddressRepository;
    private final AddressRepositoryPort addressRepository;

    public CreateUserWithAddressUseCaseImpl(UserRepositoryPort userRepositoryPort, UserAddressRepositoryPort userAddressRepositoryPort, AddressRepositoryPort addressRepositoryPort) {
    ...
    @Override
    public User execute(CreateUserWithAddressInput input) {
